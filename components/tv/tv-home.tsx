  ...
  return (
    <TVNavigationProvider initialFocusKey="hero-watch">
      <div className="min-h-screen bg-background">
        ...
        <main className="pt-28">
          ...
          <div className="py-10">
            {Object.entries(filteredSports).map(([sportName, sportData]) => (
              <div key={sportName} className="mb-14">
                ...
                <div className="px-16 mb-8">
                  <h2 className="text-4xl font-black text-foreground flex items-center gap-4 tracking-tight">
                    ...
                    {sportName}
                    <span className="text-xl font-semibold text-muted-foreground ml-3">
        ...
        {/* Navigation Hint */}
        <div className="fixed bottom-10 right-10 flex items-center gap-8 px-8 py-5 bg-secondary/90 rounded-2xl backdrop-blur-sm border border-border">
